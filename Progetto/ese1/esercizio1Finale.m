...
% CRITICITA'
% risolvere il sistema non lineare imponendo gli ingressi richiede troppo
% calcolo computazionale
% Stabiliamo il punto di equilibrio con leggi fisiche:
...
% dato il punto di equilibrio troviamo gli ingressi 
...
% La stabilità per i sistemi nonlineari è una caratteristica locale DEI PUNTI DI EQUILIBRIO.
% Lo studio della stabilità è svolta attraverso il sistema linearizzato attorno al punto di equilibrio
...
% Tutti gli autovalori sono uguali a 0 -> con essi non possiamo dire nulla
% sulla stabilità del punto di equilibrio preso in considerazione.

% La simulazione del modello senza un controllore diverge. Non avendo
% implementato il controllore non possiamo dire nulla sulla stabilità del
% punto di equilibrio
...
% Numero di soluzioni
num_solutions = length(equilibrium_solutions.p);
...
% L'unica soluzione reale trovata è la soluzione con tutte le velocità e accelerazioni pari a 0
